...
#include <unistd.h>
#include <sys/types.h>
#include <sys/stat.h>   // Added by Himal
#include <sys/wait.h>   // Added by Himal
#include <string.h>
#include <signal.h>
#include <fcntl.h>      // Added by Himal
#include <unistd.h>     // Added by Himal
#include <pwd.h>
...
static const yytype_uint8 yyprhs[] =
{
      ...
      26,    28,    31,    34,    35,    37,    39,    41,    44,    46,
      48,    49,    52,    55,    58,    61,    64
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      18,    -1,    19,    24,    25,     7,    -1,     7,    -1,     1,
       7,    -1,    19,     8,    20,    -1,    20,    -1,    23,    21,
      -1,    21,    22,    -1,    -1,     3,    -1,     4,    -1,     3,
      -1,    24,    26,    -1,    26,    -1,    13,    -1,    -1,     6,
       3,    -1,     9,     3,    -1,    10,     3,    -1,    11,     3,
      -1,    12,     3,    -1,    -1
};
...
{
       0,    56,    56,    60,    61,    65,    69,    73,    74,    78,
      79,    83,    90,    91,    95,   112,   166,   177,   178,   182,
     185,   189,   199,   209,   219,   230,   242
};
#endif
...
{
       0,     0,    16,     7,     0,     0,     3,     5,    26,    10,
      13,     8,     1,     4,     0,     0,     0,     0,     0,     0,
      20,    18,    11,    21,     9,    22,    23,    24,    25,    19,
       0,    17,    14,    15,    12,     6
};
...
{
      22,     3,    -7,    -7,    12,     8,    -7,    -7,    10,    -7,
      -7,    -7,    -7,    -7,    11,    14,    21,    23,    24,    25,
      -6,    -7,    -2,    -7,    -7,    -7,    -7,    -7,    -7,    -7,
       6,    -7,    -7,    -7,    -7,    -7
};
...
{
      14,    32,    33,    16,    17,    18,    19,    29,    -2,     1,
      11,     2,    12,    35,    23,     3,    14,     2,    15,    16,
      17,    18,    19,     1,    25,     2,    26,    27,    28,     3,
      24,    13,     0,    31
};

static const yytype_int8 yycheck[] =
{
       6,     3,     4,     9,    10,    11,    12,    13,     0,     1,
       7,     3,     0,     7,     3,     7,     6,     3,     8,     9,
      10,    11,    12,     1,     3,     3,     3,     3,     3,     7,
      15,     5,    -1,    20
};
...
static const yytype_uint8 yystos[] =
{
      ...
      23,     7,     0,    17,     6,     8,     9,    10,    11,    12,
      24,    26,    21,     3,    20,     3,     3,     3,     3,    13,
      25,    26,     3,     4,    22,     7
};
...
#line 95 "shell.y"
    {
		...
		if( strchr((yyvsp[(1) - (1)].string_val),'*') != NULL || strchr((yyvsp[(1) - (1)].string_val),'?') != NULL){
			...
			arrayCounter = 0;	
			expandWildcard(NULL, strdup((yyvsp[(1) - (1)].string_val)));
